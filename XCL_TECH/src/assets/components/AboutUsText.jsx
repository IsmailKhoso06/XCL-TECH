        ...
        <>
            <div className="container py-4">
                <div className="row align-items-md-stretch">
                    ...
                    <div className="col-md-6">
                        <h6 className="display-5 fw-bold text-center" style={welcomeCSS}>Welcome.</h6>
                        <h6 className="display-5 fw-bold text-center" style={{ lineHeight: "1.3", fontSize: "20px", letterSpacing: "8px" }} >To The New <span style={{ margin: "-10px 0px", marginLeft:"-16px", padding: "10px 30px", background: "#F67510", color: "white", borderTopLeftRadius: "20px", borderBottomRightRadius: "20px" }}>World</span> </h6>
